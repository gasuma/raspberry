...
from tkinter import messagebox as MessageBox #Importar el módulo messagebox para mensajes de pantalla

def button1_click(): # Definir la función del primer boton "button1click"
    print("Abrir")   # imprimir en la consola la palabra "Abrir"
    MessageBox.showinfo("Aviso","El tiempo de servido es de 2 segundos")
    ...
    time.sleep(2) #tiempo de espera antes de volver el servo a 0 grados
...
button1 = tk.Button(root, text="Servir", command=button1_click)
button1.pack() 
