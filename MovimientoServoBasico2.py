...
servo1.start(0)
servo1.ChangeDutyCycle(12) # Mueve el servo a 90 grados 
time.sleep(2) # Tiempo de espera de 2 segundos

print("Abriendo") # Imprime por pantalla una cadena decaracteres
wait = input("Presione Enter para continuar...")# Asignación de la función input a la variable "wait"
print("Cerrando") # Imprimir por pantalla una cadena de caracteres
